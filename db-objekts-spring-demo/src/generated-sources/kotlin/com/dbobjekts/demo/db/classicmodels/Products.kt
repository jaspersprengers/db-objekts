...
object Products:Table<ProductsRow>("products"), HasUpdateBuilder<ProductsUpdateBuilder, ProductsInsertBuilder> {
     ...
     */
    val buyPrice = DoubleColumn(this, "buyPrice")
    /**
     * Represents db column classicmodels.products.MSRP
     */
    val msrp = DoubleColumn(this, "MSRP")
    ...
    override fun toValue(values: List<Any?>) = ProductsRow(values[0] as String,values[1] as String,values[2] as String,values[3] as String,values[4] as String,values[5] as String,values[6] as Int,values[7] as Double,values[8] as Double)
...
class ProductsUpdateBuilder() : UpdateBuilderBase(Products) {
    ...
    fun buyPrice(value: Double): ProductsUpdateBuilder = put(Products.buyPrice, value)
    fun msrp(value: Double): ProductsUpdateBuilder = put(Products.msrp, value)
...
class ProductsInsertBuilder():InsertBuilderBase(){
    ...
    fun buyPrice(value: Double): ProductsInsertBuilder = put(Products.buyPrice, value)
    fun msrp(value: Double): ProductsInsertBuilder = put(Products.msrp, value)

    fun mandatoryColumns(productCode: String, productName: String, productLine: String, productScale: String, productVendor: String, productDescription: String, quantityInStock: Int, buyPrice: Double, msrp: Double) : ProductsInsertBuilder {
