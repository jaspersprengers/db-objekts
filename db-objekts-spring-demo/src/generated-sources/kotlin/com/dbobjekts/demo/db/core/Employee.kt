...
object Employee:Table<EmployeeRow>("EMPLOYEE"), HasUpdateBuilder<EmployeeUpdateBuilder, EmployeeInsertBuilder> {
     ...
     */
    val salary = NullableDoubleColumn(this, "salary")
    /**
     ...
     */
    val dateOfBirth = NullableDateColumn(this, "date_of_birth")
    /**
...
class EmployeeInsertBuilder():InsertBuilderBase(){
    ...
    fun mandatoryColumns(name: String) : EmployeeInsertBuilder {
