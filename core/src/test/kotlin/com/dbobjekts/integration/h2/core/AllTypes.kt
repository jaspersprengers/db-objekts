...
class AllTypesUpdateBuilder() : UpdateBuilderBase(AllTypes) {
    ...
    fun addressInt(value: com.dbobjekts.integration.h2.custom.AddressType): AllTypesUpdateBuilder = put(AllTypes.addressInt, value)
    fun addressIntNil(value: com.dbobjekts.integration.h2.custom.AddressType): AllTypesUpdateBuilder = put(AllTypes.addressIntNil, value)
    fun addressString(value: com.dbobjekts.integration.h2.custom.AddressType): AllTypesUpdateBuilder = put(AllTypes.addressString, value)
    fun addressStringNil(value: com.dbobjekts.integration.h2.custom.AddressType): AllTypesUpdateBuilder = put(AllTypes.addressStringNil, value)
}
...
class AllTypesInsertBuilder():InsertBuilderBase(){
    ...
    fun addressInt(value: com.dbobjekts.integration.h2.custom.AddressType): AllTypesInsertBuilder = put(AllTypes.addressInt, value)
    fun addressIntNil(value: com.dbobjekts.integration.h2.custom.AddressType): AllTypesInsertBuilder = put(AllTypes.addressIntNil, value)
    fun addressString(value: com.dbobjekts.integration.h2.custom.AddressType): AllTypesInsertBuilder = put(AllTypes.addressString, value)
    fun addressStringNil(value: com.dbobjekts.integration.h2.custom.AddressType): AllTypesInsertBuilder = put(AllTypes.addressStringNil, value)
