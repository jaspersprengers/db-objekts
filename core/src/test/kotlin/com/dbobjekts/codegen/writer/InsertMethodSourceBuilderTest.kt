...
class InsertMethodSourceBuilderTest {
    ...
    fun column(
        ...
        DBColumnDefinition(TableName("Employee"), ColumnName(colName), col, null)

    val id = DBAutoGeneratedKeyDefinition(
        table = TableName("Employee"),
        columnName = ColumnName("id"),
        columnType = Columns.AUTOKEY_LONG
    )
    val name = column("name", Columns.VARCHAR)
    val age = column("age", Columns.INTEGER_NIL)
    val hobbies = column("hobbies", Columns.VARCHAR_NIL)
    val married = column("married", Columns.BOOLEAN_NIL)
