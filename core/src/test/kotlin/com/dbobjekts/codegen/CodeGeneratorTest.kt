...
class CodeGeneratorTest {
    ...
    val generator: CodeGenerator = CodeGenerator()
    ...
    fun `create schemas`() {
        ...
        val id = TableMetaDataRow(schema = "core", table = "EMPLOYEE", column = "id", dataType = "BIGINT", isPrimaryKey = true, nullable = false, autoIncrement = true)
        val name = id.copy(column = "name", isPrimaryKey = false, dataType = "CHARACTER VARYING", nullable = true)
        parserFactory.addRow(id).addRow(name)

        //mappingConf.sequenceForPrimaryKey("core", "EMPLOYEE", "id", "EMPLOYEE_SEQ")

        generator.outputConfigurer()
            .basePackageForSources("com.dbobjekts.integration.h2")
            .catalogName("H2Catalog")
            .sourceWriter(writer)
        ...
        assertThat(idCol.column).isInstanceOf(AutoKeyLongColumn::class.java)
