...
class EmployeeAddressUpdateBuilder(connection: ConnectionAdapter) : UpdateBuilderBase(EmployeeAddress, connection) {
    ...
    fun kind(value: com.dbobjekts.example.custom.AddressType?): EmployeeAddressUpdateBuilder = ct.put(EmployeeAddress.kind, value)
}
...
class EmployeeAddressInsertBuilder(connection: ConnectionAdapter): InsertBuilderBase(EmployeeAddress, connection){
    ...
    fun kind(value: com.dbobjekts.example.custom.AddressType?): EmployeeAddressInsertBuilder = ct.put(EmployeeAddress.kind, value)
