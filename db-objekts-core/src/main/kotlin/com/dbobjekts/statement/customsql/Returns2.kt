...
class Returns2<T1, T2>(
   ...
   /**
      ...
      */
    fun <E : Enum<E>> enumAsString(clz: Class<E>): Returns3<T1, T2, E> = Returns3(column1, column2, ColumnFactory.forEnumAsString(clz), semaphore, conn, sql, args)
      ...
      * @param clz a valid Enum class
      */
    fun <E : Enum<E>> enumAsStringNil(clz: Class<E>): Returns3<T1, T2, E?> = Returns3(column1, column2, ColumnFactory.forNullableEnumAsString(clz), semaphore, conn, sql, args)
      ...
      * @param clz a valid Enum class
      */
    fun <E : Enum<E>> enumAsInt(clz: Class<E>): Returns3<T1, T2, E> = Returns3(column1, column2, ColumnFactory.forEnumAsInt(clz), semaphore, conn, sql, args)
    ...
    /**
      ...
      * @param clz a valid Enum class
      */
    fun <E : Enum<E>> enumAsIntNil(clz: Class<E>): Returns3<T1, T2, E?> = Returns3(column1, column2, ColumnFactory.forNullableEnumAsInt(clz), semaphore, conn, sql, args)
     ...
     */               
    fun <R> column(col: NonNullableColumn<R>): Returns3<T1, T2, R> = Returns3(column1, column2, col, semaphore, conn, sql, args)
    
    /**
     * Adds a custom nullable Column type as the next column in the result row.
     * @param clz a subclass of NullableColumn<*>             
     */
    fun <R> columnNil(col: NullableColumn<R>): Returns3<T1, T2, R> = Returns3(column1, column2, col, semaphore, conn, sql, args)
     ...
     */
    fun forEachRow(predicate: (Int, Tuple2<T1, T2>) -> Boolean) {
        semaphore.clear()
     ...
     * ```
     */
    fun iterator(): ResultSetIterator<Tuple2<T1, T2>, ResultRow2<T1, T2>> = execute().iterator()
}
