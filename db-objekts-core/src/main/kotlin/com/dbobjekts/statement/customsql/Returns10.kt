...
class Returns10<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10>(
   ...
   /**
      ...
      */
    fun <E : Enum<E>> enumAsString(clz: Class<E>): Returns11<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, E> = Returns11(column1, column2, column3, column4, column5, column6, column7, column8, column9, column10, ColumnFactory.forEnumAsString(clz), semaphore, conn, sql, args)
      ...
      * @param clz a valid Enum class
      */
    fun <E : Enum<E>> enumAsStringNil(clz: Class<E>): Returns11<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, E?> = Returns11(column1, column2, column3, column4, column5, column6, column7, column8, column9, column10, ColumnFactory.forNullableEnumAsString(clz), semaphore, conn, sql, args)
      ...
      * @param clz a valid Enum class
      */
    fun <E : Enum<E>> enumAsInt(clz: Class<E>): Returns11<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, E> = Returns11(column1, column2, column3, column4, column5, column6, column7, column8, column9, column10, ColumnFactory.forEnumAsInt(clz), semaphore, conn, sql, args)
    ...
    /**
      ...
      * @param clz a valid Enum class
      */
    fun <E : Enum<E>> enumAsIntNil(clz: Class<E>): Returns11<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, E?> = Returns11(column1, column2, column3, column4, column5, column6, column7, column8, column9, column10, ColumnFactory.forNullableEnumAsInt(clz), semaphore, conn, sql, args)
     ...
     */               
    fun <R> column(col: NonNullableColumn<R>): Returns11<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, R> = Returns11(column1, column2, column3, column4, column5, column6, column7, column8, column9, column10, col, semaphore, conn, sql, args)
    
    /**
     * Adds a custom nullable Column type as the next column in the result row.
     * @param clz a subclass of NullableColumn<*>             
     */
    fun <R> columnNil(col: NullableColumn<R>): Returns11<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, R> = Returns11(column1, column2, column3, column4, column5, column6, column7, column8, column9, column10, col, semaphore, conn, sql, args)
     ...
     */
    fun forEachRow(predicate: (Int, Tuple10<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10>) -> Boolean) {
        semaphore.clear()
     ...
     * ```
     */
    fun iterator(): ResultSetIterator<Tuple10<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10>, ResultRow10<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10>> = execute().iterator()
}
