...
class Returns7<T1, T2, T3, T4, T5, T6, T7>(
   ...
   /**
      ...
      */
    fun <E : Enum<E>> enumAsString(clz: Class<E>): Returns8<T1, T2, T3, T4, T5, T6, T7, E> = Returns8(column1, column2, column3, column4, column5, column6, column7, ColumnFactory.forEnumAsString(clz), semaphore, conn, sql, args)
      ...
      * @param clz a valid Enum class
      */
    fun <E : Enum<E>> enumAsStringNil(clz: Class<E>): Returns8<T1, T2, T3, T4, T5, T6, T7, E?> = Returns8(column1, column2, column3, column4, column5, column6, column7, ColumnFactory.forNullableEnumAsString(clz), semaphore, conn, sql, args)
      ...
      * @param clz a valid Enum class
      */
    fun <E : Enum<E>> enumAsInt(clz: Class<E>): Returns8<T1, T2, T3, T4, T5, T6, T7, E> = Returns8(column1, column2, column3, column4, column5, column6, column7, ColumnFactory.forEnumAsInt(clz), semaphore, conn, sql, args)
    ...
    /**
      ...
      * @param clz a valid Enum class
      */
    fun <E : Enum<E>> enumAsIntNil(clz: Class<E>): Returns8<T1, T2, T3, T4, T5, T6, T7, E?> = Returns8(column1, column2, column3, column4, column5, column6, column7, ColumnFactory.forNullableEnumAsInt(clz), semaphore, conn, sql, args)
     ...
     */               
    fun <R> column(col: NonNullableColumn<R>): Returns8<T1, T2, T3, T4, T5, T6, T7, R> = Returns8(column1, column2, column3, column4, column5, column6, column7, col, semaphore, conn, sql, args)
    
    /**
     * Adds a custom nullable Column type as the next column in the result row.
     * @param clz a subclass of NullableColumn<*>             
     */
    fun <R> columnNil(col: NullableColumn<R>): Returns8<T1, T2, T3, T4, T5, T6, T7, R> = Returns8(column1, column2, column3, column4, column5, column6, column7, col, semaphore, conn, sql, args)
     ...
     */
    fun forEachRow(predicate: (Int, Tuple7<T1, T2, T3, T4, T5, T6, T7>) -> Boolean) {
        semaphore.clear()
     ...
     * ```
     */
    fun iterator(): ResultSetIterator<Tuple7<T1, T2, T3, T4, T5, T6, T7>, ResultRow7<T1, T2, T3, T4, T5, T6, T7>> = execute().iterator()
}
