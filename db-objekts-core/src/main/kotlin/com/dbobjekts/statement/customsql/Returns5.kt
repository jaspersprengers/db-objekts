...
class Returns5<T1, T2, T3, T4, T5>(
   ...
   /**
      ...
      */
    fun <E : Enum<E>> enumAsString(clz: Class<E>): Returns6<T1, T2, T3, T4, T5, E> = Returns6(column1, column2, column3, column4, column5, ColumnFactory.forEnumAsString(clz), semaphore, conn, sql, args)
      ...
      * @param clz a valid Enum class
      */
    fun <E : Enum<E>> enumAsStringNil(clz: Class<E>): Returns6<T1, T2, T3, T4, T5, E?> = Returns6(column1, column2, column3, column4, column5, ColumnFactory.forNullableEnumAsString(clz), semaphore, conn, sql, args)
      ...
      * @param clz a valid Enum class
      */
    fun <E : Enum<E>> enumAsInt(clz: Class<E>): Returns6<T1, T2, T3, T4, T5, E> = Returns6(column1, column2, column3, column4, column5, ColumnFactory.forEnumAsInt(clz), semaphore, conn, sql, args)
    ...
    /**
      ...
      * @param clz a valid Enum class
      */
    fun <E : Enum<E>> enumAsIntNil(clz: Class<E>): Returns6<T1, T2, T3, T4, T5, E?> = Returns6(column1, column2, column3, column4, column5, ColumnFactory.forNullableEnumAsInt(clz), semaphore, conn, sql, args)
     ...
     */               
    fun <R> column(col: NonNullableColumn<R>): Returns6<T1, T2, T3, T4, T5, R> = Returns6(column1, column2, column3, column4, column5, col, semaphore, conn, sql, args)
    
    /**
     * Adds a custom nullable Column type as the next column in the result row.
     * @param clz a subclass of NullableColumn<*>             
     */
    fun <R> columnNil(col: NullableColumn<R>): Returns6<T1, T2, T3, T4, T5, R> = Returns6(column1, column2, column3, column4, column5, col, semaphore, conn, sql, args)
     ...
     */
    fun forEachRow(predicate: (Int, Tuple5<T1, T2, T3, T4, T5>) -> Boolean) {
        semaphore.clear()
     ...
     * ```
     */
    fun iterator(): ResultSetIterator<Tuple5<T1, T2, T3, T4, T5>, ResultRow5<T1, T2, T3, T4, T5>> = execute().iterator()
}
