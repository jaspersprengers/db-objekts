...
class TransactionManager private constructor(
    ...
    class TransactionManagerBuilder {
         ...
         *
         * A Catalog reference is essential for creating queries with the generated metadata objects.
         *
         * @param the [Catalog] associated with the [DataSource]
         * @thros com.dbobjekts.api.exception.DBObjektsException if the major version of this catalog is too much behind and would cause compatability issues
         */
