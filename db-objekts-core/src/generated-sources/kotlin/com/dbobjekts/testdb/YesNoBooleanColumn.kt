...
class YesNoBooleanColumn(table: Table, name: String) : NonNullableColumn<Boolean>(name, table, Boolean::class.java) {
...
class NullableYesNoBooleanColumn(table: Table, name: String) :
